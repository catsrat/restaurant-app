        ...
        <div className="bg-[#0B0C10] text-gray-300 min-h-screen font-sans selection:bg-purple-500/30 overflow-x-hidden">
            ...
            <section id="features" className="max-w-7xl mx-auto px-6 py-10 lg:py-20 relative z-20 bg-[#0B0C10]">
                ...
                >
                    ...
                    <motion.div
                        variants={fadeInUp}
                        className="bg-gradient-to-br from-gray-900/50 to-gray-800/50 rounded-3xl p-8 border border-white/10 hover:border-blue-500/30 transition group overflow-hidden relative flex flex-col"
                    >
                        <div className="relative z-10">
                            ...
                            <p className="text-gray-400 mb-6">Scan and order from any device. No app required.</p>
                        </div>

                        {/* Full width static menu container */}
                        <div className="relative flex-1 -mx-8 -mb-8 overflow-hidden border-t border-white/5 bg-black/20 min-h-[240px]">
                            ...
                            <div className="absolute inset-0 pointer-events-none shadow-[inset_0_4px_20px_rgba(0,0,0,0.5)]"></div>
                        </div>
